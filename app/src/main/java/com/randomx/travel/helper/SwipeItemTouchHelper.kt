package com.randomx.travel.helper
...
class SwipeItemTouchHelper(private val mAdapter: SwipeHelperAdapter) : ItemTouchHelper.Callback() {
    ...
    override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, dX: Float, dY: Float, actionState: Int, isCurrentlyActive: Boolean) {
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            val background: Drawable = ColorDrawable().apply {
                setColor(getBgColorCode())
            }
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?, actionState: Int) {
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder is TouchViewHolder) {
                ...
                val itemViewHolder: TouchViewHolder = viewHolder
